...
8.  `portfolio_report.tex`: The TeX File used to generate the final report.
9.  `references.bib`: The references file used in generating the final report.
10.  Figures and Tables: A folder containing the figure and table `.png` files for the portfolio slides and report and the `.gif` used in the presentation.
